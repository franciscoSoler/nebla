...
ControllerR16_Cinta15::ControllerR16_Cinta15() {
    try {
        ...
        inputQueueR16_Cinta15_ = IPC::MsgQueue("inputQueueR16_Cinta15", 1, ID_TIPO_ROBOT16_CINTA);
        inputQueueR16_Cinta15_.getMsgQueue(DIRECTORY_ROBOT_16, MSGQUEUE_R16_CINTA15_INPUT_ID);
        
        inputQueueDespacho_ = IPC::MsgQueue("inputQueueDespacho", 1, ID_TIPO_ROBOT16_CINTA);
