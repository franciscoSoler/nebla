...
listadoclientes_2_svc(void *argp, struct svc_req *rqstp)
{
	...
	{
		numeradorInfo = (NumeradorInfo*)data;
		memcpy(result.retorno_u.informacion,numeradorInfo->numerosClientes,MAX_CLIENTES);
	}		
	signal(0);
...
listadovendedores_2_svc(void *argp, struct svc_req *rqstp)
{
	...
	{
		numeradorInfo = (NumeradorInfo*)data;
		memcpy (result.retorno_u.informacion, numeradorInfo->numerosVendedores, MAX_VENDEDORES);
	}		
	signal(0);
